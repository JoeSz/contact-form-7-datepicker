...
class ContactForm7Datepicker_Admin {
	...
	function ajax_save_settings() {
		 ...
		 * Capability check
		 *
		 * "The Contact Form 7 Datepicker plugin allows users to add a datepicker to forms generated by Contact Form 7,
		 * and it includes the ability to modify settings for these datepickers. In order to process these settings,
		 * it registered an AJAX action calling a function that failed to include a capability check or a nonce check."
		 *
		 * @link https://www.wordfence.com/blog/2020/04/high-severity-vulnerability-leads-to-closure-of-plugin-with-over-100000-installations/
		 */
